        ...
        return (
            <form className="content__box-product-add" method="POST" encType="multipart/form-data" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="content__box-product-add-field">
                    ...
                    <input type="number" {...register('quantity', { required: "Bạn cần nhập số lượng", value: 0 })} placeholder="số lượng" className="input-txt" />
                    <ErrorMessage
                        errors={errors}
                        name="quantity"
                        render={({ messages }) =>
                ...
                <div className="content__box-product-add-field editer">
                    ...
                    <textarea {...register('description', { required: "Bạn cần nhập mô tả", maxLength: { value: 255, message: "Bạn Nhập mô tả quá dài quá dài" } })} cols={30} rows={10} placeholder="mô tả" className="txt-box" />
                </div>
